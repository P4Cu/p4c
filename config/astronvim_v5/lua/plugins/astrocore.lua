  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ["<C-_>"] = { "gc", desc = "Toggle comment line" },
        ...
        ["<F1>"] = { function() require("snacks").picker() end, desc = "All pickers" },
        ["<F13>"] = { function() require("snacks.picker").resume() end, desc = "Picker resume" },
        ["<S-F1>"] = { function() require("snacks.picker").resume() end, desc = "Picker resume" },
      ...
      v = {
        ["<BS>"] = { '"_x', desc = "Black hole delete" },
        ["<Del>"] = { '"_x', desc = "Black hole delete" },
        ["<C-_>"] = { "gc", desc = "Toggle comment selection" },

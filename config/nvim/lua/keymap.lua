...
return {
    setup = setup,
    dapui = {
        toggle_breakpoint = '<LocalLeader>db',
        set_logpoint = '<LocalLeader>dBL',
        set_conditional_breakpoint = '<LocalLeader>dBC',
        run_last = '<LocalLeader>dl',
        terminate = '<LocalLeader>dT',
        continue = '<F5>',

        -- TODO: also most of these could be buffer local bindings for specific windows
        step_over = '<F10>',
        step_into = '<F11>',
        step_out = '<F23>',
        repl = '<LocalLeader>dr',
        hover = '<LocalLeader>dh',
        preview = '<LocalLeader>dp',
        frames_float = '<LocalLeader>df',
        scopes_float = '<LocalLeader>ds',
    },
}
